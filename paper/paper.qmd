...
The estimand is the effect of income level, employment status, and living area on the odds of voting for Biden, measured as the change in predicted odds associated with each predictor, holding other factors constant.
...
The appendix explores survey methodologies, focusing on sampling and observational data in the CCES dataset. It compares methodologies, examines sampling variability and bias, and uses simulations to expand on points in the data section.
